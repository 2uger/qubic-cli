...
enum COMMAND
{
    ...
    QLOAN_PLACE_LOAN_REQUEST_CMD,
    QLOAN_REMOVE_LOAN_REQUEST_CMD,
    QLOAN_ACCEPT_LOAN_REQUEST_CMD,
    QLOAN_RELEASE_ASSET_CMD,
    QLOAN_PAY_LOAN_DEBT_CMD,
    QLOAN_GET_ALL_LOAN_REQUESTS_CMD,
    QLOAN_GET_USER_ACTIVE_LOAN_REQUESTS_CMD,
    QLOAN_GET_ACCEPTED_LOAN_REQUESTS_CMD,
    QLOAN_GET_FEES_CMD,
    QLOAN_GET_USER_DEBT_CMD,
